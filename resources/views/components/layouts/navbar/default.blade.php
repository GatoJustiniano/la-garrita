      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
          <div class="avatar avatar-online">
            <img src="{{ Auth::user()->profile_photo_url ?? asset('img/users/1.png') }}" alt
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          ...
          <li>
            <a class="dropdown-item {{ request()->routeIs('settings.password') ? 'active' : '' }}"
              ...
              <i class="icon-base bx bx-cog icon-md me-3"></i><span>Config</span>
            </a>
          </li>
          <li>
            <div class="dropdown-divider my-1"></div>
          ...
          <li>
            <form method="POST" action="{{ route('logout') }}">
              ...
              <button class="dropdown-item" type="submit" class="btn p-0"><i
                  class="icon-base bx bx-power-off icon-md me-3"></i><span>Cerrar Sesión</span></button>
            </form>
          </li>
        </ul>
        @else
        ...
        <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
          <div class="avatar avatar-online">
            <img src="{{ asset('img/users/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
          </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
