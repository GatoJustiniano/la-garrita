<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="layout-navbar-fixed layout-wide "
  data-skin="default" dir="ltr" data-bs-theme="light" data-assets-path="{{ asset('/') }}" data-template="front-pages">
...
<head>
  ...
  <!-- Core CSS -->
  <link rel="stylesheet" href="{{ asset('css/frontend/pickr-themes.css') }}" />
  <link rel="stylesheet" href="{{ asset('css/bt5/core.css') }}" />
  <link rel="stylesheet" href="{{ asset('css/bt5/demo.css') }}" />
  <link rel="stylesheet" href="{{ asset('css/frontend/front-page.css') }}" />

  <!-- Vendors CSS -->
  <!-- endbuild -->
  <link rel="stylesheet" href="{{ asset('css/frontend/nouislider.css') }}" />
  <link rel="stylesheet" href="{{ asset('css/frontend/swiper.css') }}" />
  <link rel="stylesheet" href="{{ asset('css/frontend/iconify-icons.css') }}" />

  <!-- Page CSS -->
  <link rel="stylesheet" href="{{ asset('css/frontend/front-page-landing.css') }}" />

  <!-- Helpers -->
  <script src="{{ asset('js/frontend/helpers.js') }}"></script>
  <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
  <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
  <script src="{{ asset('js/frontend/template-customizer.js') }}"></script>
...
<div data-bs-spy="scroll" class="scrollspy-example">
  ...
  <section id="hero-animation">
    <div id="landingHero" class="section-py landing-hero position-relative">
      <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/backgrounds/hero-bg.png" alt="hero background"
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo-6.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam nemo
                        mollitia, ad eum officia numquam nostrum repellendus consequuntur!</p>
                      <div class="text-warning mb-4">
                        <i class="icon-base bx bxs-star"></i>
                        <i class="icon-base bx bxs-star"></i>
                        <i class="icon-base bx bxs-star"></i>
          ...
          <div class="card">
            <div class="card-header">
              <div class="text-center">
                <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/icons/paper-airplane.png" alt="paper airplane icon"
                  class="mb-8 pb-2" />
  ...
  <section id="landingFAQ" class="section-py bg-body landing-faq">
    <div class="container">
      ...
      <div class="row gy-12 align-items-center">
        <div class="col-lg-5">
          <div class="text-center">
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/faq-boy-with-logos.png" alt="faq boy with logos"
              class="faq-image" />
          </div>
        </div>
        <div class="col-lg-7">
      ...
      <div class="row g-6">
        <div class="col-lg-5">
          <div class="contact-img-box position-relative border p-2 h-100">
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/icons/contact-border.png" alt="contact border"
              class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/contact-customer-service.png"
...
<footer class="landing-footer bg-body footer-text">
  <div class="footer-top position-relative overflow-hidden z-1">
    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/backgrounds/footer-bg.png" alt="footer bg"
      ...
      <div class="row gx-0 gy-6 g-lg-10">
        ...
        <div class="col-lg-3 col-md-4">
          ...
          <a href="javascript:void(0);" class="d-block">
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" />
          </a>
        </div>
      </div>
    </div>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        <a href="https://github.com/gatojustiniano" class="me-4 text-white" target="_blank">
...
<!-- Main JS -->
<script src="{{ asset('js/frontend/front-main.js') }}"></script>
<!-- Page JS -->
<script src="{{ asset('js/frontend/front-page-landing.js') }}"></script>
